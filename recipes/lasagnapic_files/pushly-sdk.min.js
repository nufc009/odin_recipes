...
PushlySDK.watch('ready', () => {
    ...
    try {
        let qss = document.querySelectorAll('script[type="application/ld+json"]');
        if (qss) {
            qss.forEach(qs => {
